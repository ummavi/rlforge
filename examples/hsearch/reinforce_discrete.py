...
config_space = {
    ...
    "policy_learning_rate": hp.choice("policy_learning_rate",[1e-2,5e-3,1e-3,5e-4,1e-4,5e-5,1e-5]),
    "baseline_layer_sizes": [64, 64],
    "entropy_coeff": hp.choice("entropy_coeff",[0.0001,0.001,0.01,0.1,1.,2,3]),
    "baseline_learning_rate": hp.choice("baseline_learning_rate",[1e-2,5e-3,1e-3,5e-4,1e-4,5e-5,1e-5]),
    "seeds": [1, 2, 3, 4, 5],
...
def run(expt_config, result_q):
    ...
    def agent_setup(env_name, seed, gamma, policy_layer_sizes,
                  ...
                  n_train_episodes, activation_fn):
        ...
        policy_config = dict(layer_sizes=policy_layer_sizes, activation=activation_fn)
...
if __name__ == "__main__":
    ...
    """
    Best configuration: {'activation_fn': 0, 'baseline_learning_rate': 0, 'entropy_coeff': 1, 'gamma': 2, 'policy_learning_rate': 3}
    best_config = {
        "env_name": "CartPole-v0",
        "n_train_episodes": 150,
        "gamma": 0.9,
