...
if __name__ == "__main__":
    ...
    """
    For shared weight network:
    Best configuration: {'activation_fn': 0, 'entropy_coeff': 3, 'gamma': 4, 'model_layer_sizes': 1, 'model_learning_rate': 0, 'n_steps': 3, 'n_workers': 2, 'v_function_coeff': 1}
    best_config = {
        "env_name": "CartPole-v0",
        "n_train_episodes": 250,
        "seeds": [1, 2, 3, 4, 5],
        ...
        "activation_fn": hp.choice('activation_fn', ["tanh", "relu"]),
        "entropy_coeff": 1.0,
        "v_function_coeff": 0.1,
        "model_learning_rate": 1e-3,
    }

    --------------------
    For independent network:
     {'activation_fn': 0, 'entropy_coeff': 3, 'gamma': 4, 'model_layer_sizes': 1, 'model_learning_rate': 0, 'n_steps': 1, 'n_workers': 0, 'v_function_coeff': 4
     # Define a config space
config_space = {
    "env_name": "CartPole-v0",
    "n_train_episodes": 250,
